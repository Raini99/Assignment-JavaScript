...
console.log("-----Pengecekan Driving Licence-----")
const userAge = 18;
...
switch (unit) {
  /// EDIT HERE
    ...
    case "K" : console.log(temperature +273);
        break;
    case "F" : console.log((9/5) * temperature + 32);
        break;
    case "C" : console.log(temperature === temperature);
        break;
