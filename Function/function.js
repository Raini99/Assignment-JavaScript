...
/// EDIT HERE
console.log("-----Penghitungan Pajak-----");
...
/// EDIT HERE
console.log("-----Merubah huruf pertama setiap kata menjadi kapital-----");
...
/// EDIT HERE
console.log("-----Fungsi Mengembalikan Huruf Pertama Yang Tidak Kembar-----");
function convToUpperCase(sentence) {
    const arr = sentence.split(" "); 
    for (var i = 0; i < arr.length; i++) {
        arr[i] = arr[i].charAt(0).toUpperCase() + arr[i].slice(1);
